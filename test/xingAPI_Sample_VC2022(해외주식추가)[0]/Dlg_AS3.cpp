// Dlg_AS3.cpp : implementation file
//
...
IMPLEMENT_DYNCREATE(CDlg_AS3, CDialog)

CDlg_AS3::CDlg_AS3(CWnd* pParent /*=NULL*/)
	: CDialog(CDlg_AS3::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDlg_AS3)
		// NOTE: the ClassWizard will add member initialization here
	//}}AFX_DATA_INIT
}


void CDlg_AS3::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlg_AS3)
	DDX_Control(pDX, IDC_OUTBLOCK, m_ctrlOutBlock);
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CDlg_AS3, CDialog)
	//{{AFX_MSG_MAP(CDlg_AS3)
...
/////////////////////////////////////////////////////////////////////////////
// CDlg_AS3 message handlers

BOOL CDlg_AS3::OnInitDialog() 
{
...
// 데이터를 받음
//--------------------------------------------------------------------------------------
LRESULT CDlg_AS3::OnXMReceiveRealData( WPARAM wParam, LPARAM lParam )
{
	LPRECV_REAL_PACKET pRealPacket = (LPRECV_REAL_PACKET)lParam;

	if( strcmp( pRealPacket->szTrCode, "AS3" ) == 0 )
	{
		LPAS3_OutBlock pOutBlock = (LPAS3_OutBlock)pRealPacket->pszData;
		int nRow = 0;
