// Dlg_CCEAT00200.cpp : implementation file
//

#include "stdafx.h"
#include "xingapi_sample.h"
#include "Dlg_CCEAT00200.h"

#include "./Packet/CCEAT00200.h"
...
IMPLEMENT_DYNCREATE(CDlg_CCEAT00200, CDialog)

CDlg_CCEAT00200::CDlg_CCEAT00200(CWnd* pParent /*=NULL*/)
	: CDialog(CDlg_CCEAT00200::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDlg_CCEAT00200)
		// NOTE: the ClassWizard will add member initialization here
	//}}AFX_DATA_INIT
}


void CDlg_CCEAT00200::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlg_CCEAT00200)
...
BEGIN_MESSAGE_MAP(CDlg_CCEAT00200, CDialog)
	//{{AFX_MSG_MAP(CDlg_CCEAT00200)
...
/////////////////////////////////////////////////////////////////////////////
// CDlg_CCEAT00200 message handlers

BOOL CDlg_CCEAT00200::OnInitDialog() 
{
...
void CDlg_CCEAT00200::OnButtonRequest() 
{
	RequestData();
}
...
// 컨트롤 초기화
//--------------------------------------------------------------------------------------
void CDlg_CCEAT00200::InitCtrls()
{
	int nCol;
...
// 데이터 조회
//--------------------------------------------------------------------------------------
void CDlg_CCEAT00200::RequestData( BOOL bNext )
{
	//-----------------------------------------------------------
// 현물정상주문(CCEAT00200) ( base21=SONAT000,headtype=B )
	CCEAT00200InBlock1	pckInBlock;

	TCHAR			szTrNo[]		= "CCEAT00200";
	char			szNextKey[]		= "";
...
// 데이터를 받음
//--------------------------------------------------------------------------------------
LRESULT CDlg_CCEAT00200::OnXMReceiveData( WPARAM wParam, LPARAM lParam )
{
	//-------------------------------------------------------------------------------------
	// Data를 받음
	if( wParam == REQUEST_DATA )
	{
		typedef struct
		{
			CCEAT00200OutBlock1	outBlock1;
			CCEAT00200OutBlock2	outBlock2;
		} CCEAT00200AllOutBlock, *LPCCEAT00200AllOutBlock;
		
		LPRECV_PACKET			pRpData		 = (LPRECV_PACKET)lParam;
		LPCCEAT00200AllOutBlock pAllOutBlock = (LPCCEAT00200AllOutBlock)pRpData->lpData;
		int						nDataLength  = pRpData->nDataLength;
		int						nCol;
		
		//------------------------------------------------
		// OutBlock1
		nDataLength -= sizeof( CCEAT00200OutBlock1 );
		if( nDataLength < 0 )
		{
			return 0L;
		}
		...
		//------------------------------------------------
		// OutBlock1
		nDataLength -= sizeof( CCEAT00200OutBlock2 );
		if( nDataLength < 0 )
		{
			return 0L;
		}
...
// Timeout 발생
//--------------------------------------------------------------------------------------
LRESULT CDlg_CCEAT00200::OnXMTimeoutData( WPARAM wParam, LPARAM lParam )
{
	g_iXingAPI.ReleaseRequestData( (int)lParam );
