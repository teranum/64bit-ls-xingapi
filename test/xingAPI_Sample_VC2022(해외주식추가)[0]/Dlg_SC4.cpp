// Dlg_SC4.cpp : implementation file
//
...
IMPLEMENT_DYNCREATE(CDlg_SC4, CDialog)

CDlg_SC4::CDlg_SC4(CWnd* pParent /*=NULL*/)
	: CDialog(CDlg_SC4::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDlg_SC4)
	//}}AFX_DATA_INIT
}


void CDlg_SC4::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlg_SC4)
	DDX_Control(pDX, IDC_OUTBLOCK, m_ctrlOutBlock);
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CDlg_SC4, CDialog)
	//{{AFX_MSG_MAP(CDlg_SC4)
...
/////////////////////////////////////////////////////////////////////////////
// CDlg_SC4 message handlers

BOOL CDlg_SC4::OnInitDialog() 
{
...
// 데이터를 받음
//--------------------------------------------------------------------------------------
LRESULT CDlg_SC4::OnXMReceiveRealData( WPARAM wParam, LPARAM lParam )
{
	LPRECV_REAL_PACKET pRealPacket = (LPRECV_REAL_PACKET)lParam;

	if( strcmp( pRealPacket->szTrCode, "SC4" ) == 0 )
	{
		LPSC4_OutBlock pOutBlock = (LPSC4_OutBlock)pRealPacket->pszData;
		int nRow = 0;
