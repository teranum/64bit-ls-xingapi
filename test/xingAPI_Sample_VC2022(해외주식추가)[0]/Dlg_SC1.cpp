// Dlg_SC1.cpp : implementation file
//
...
IMPLEMENT_DYNCREATE(CDlg_SC1, CDialog)

CDlg_SC1::CDlg_SC1(CWnd* pParent /*=NULL*/)
	: CDialog(CDlg_SC1::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDlg_SC1)
		// NOTE: the ClassWizard will add member initialization here
	//}}AFX_DATA_INIT
}


void CDlg_SC1::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlg_SC1)
	DDX_Control(pDX, IDC_OUTBLOCK, m_ctrlOutBlock);
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CDlg_SC1, CDialog)
	//{{AFX_MSG_MAP(CDlg_SC1)
...
/////////////////////////////////////////////////////////////////////////////
// CDlg_SC1 message handlers

BOOL CDlg_SC1::OnInitDialog() 
{
...
// 데이터를 받음
//--------------------------------------------------------------------------------------
LRESULT CDlg_SC1::OnXMReceiveRealData( WPARAM wParam, LPARAM lParam )
{
	LPRECV_REAL_PACKET pRealPacket = (LPRECV_REAL_PACKET)lParam;

	if( strcmp( pRealPacket->szTrCode, "SC1" ) == 0 )
	{
