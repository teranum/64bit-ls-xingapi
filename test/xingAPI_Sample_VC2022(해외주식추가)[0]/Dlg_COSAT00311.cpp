// Dlg_COSAT00311.cpp : implementation file
//

#include "stdafx.h"
#include "xingapi_sample.h"
#include "Dlg_COSAT00311.h"

#include "./Packet/COSAT00311.h"
...
IMPLEMENT_DYNCREATE(CDlg_COSAT00311, CDialog)

CDlg_COSAT00311::CDlg_COSAT00311(CWnd* pParent /*=NULL*/)
	: CDialog(CDlg_COSAT00311::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDlg_COSAT00311)
		// NOTE: the ClassWizard will add member initialization here
	//}}AFX_DATA_INIT
}


void CDlg_COSAT00311::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlg_COSAT00311)
...
BEGIN_MESSAGE_MAP(CDlg_COSAT00311, CDialog)
	//{{AFX_MSG_MAP(CDlg_COSAT00311)
...
/////////////////////////////////////////////////////////////////////////////
// CDlg_COSAT00311 message handlers

BOOL CDlg_COSAT00311::OnInitDialog() 
{
...
void CDlg_COSAT00311::OnButtonRequest() 
{
	RequestData();
}
...
// 컨트롤 초기화
//--------------------------------------------------------------------------------------
void CDlg_COSAT00311::InitCtrls()
{
	int nCol;
...
// 데이터 조회
//--------------------------------------------------------------------------------------
void CDlg_COSAT00311::RequestData( BOOL bNext )
{
	//-----------------------------------------------------------
// 현물정정주문(COSAT00311) ( base21=SONAT000,headtype=B )
	COSAT00311InBlock1	pckInBlock;

	TCHAR			szTrNo[]		= "COSAT00311";
	char			szNextKey[]		= "";
...
// 데이터를 받음
//--------------------------------------------------------------------------------------
LRESULT CDlg_COSAT00311::OnXMReceiveData( WPARAM wParam, LPARAM lParam )
{
	//-------------------------------------------------------------------------------------
	// Data를 받음
	if( wParam == REQUEST_DATA )
	{
		...
		typedef struct
		{
			COSAT00311OutBlock1	outBlock1;
			COSAT00311OutBlock2	outBlock2;
		} COSAT00311AllOutBlock, *LPCOSAT00311AllOutBlock;

		LPCOSAT00311AllOutBlock pAllOutBlock = (LPCOSAT00311AllOutBlock)pRpData->lpData;

		// 받은 데이터 크기가 Block 크기보다 작다면 처리하지 않는다.
		if( pRpData->nDataLength >= sizeof( COSAT00311OutBlock1 ) )
		{
			int nCol = 0;
		...
		if( pRpData->nDataLength >= sizeof( COSAT00311OutBlock1 ) + sizeof( COSAT00311OutBlock2 ) )
		{
			int nCol = 0;
...
// Timeout 발생
//--------------------------------------------------------------------------------------
LRESULT CDlg_COSAT00311::OnXMTimeoutData( WPARAM wParam, LPARAM lParam )
{
	g_iXingAPI.ReleaseRequestData( (int)lParam );
