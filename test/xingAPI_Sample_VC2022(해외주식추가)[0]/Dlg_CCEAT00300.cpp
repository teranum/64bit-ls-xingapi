// Dlg_CCEAT00300.cpp : implementation file
//

#include "stdafx.h"
#include "xingapi_sample.h"
#include "Dlg_CCEAT00300.h"

#include "./Packet/CCEAT00300.h"
...
IMPLEMENT_DYNCREATE(CDlg_CCEAT00300, CDialog)

CDlg_CCEAT00300::CDlg_CCEAT00300(CWnd* pParent /*=NULL*/)
	: CDialog(CDlg_CCEAT00300::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDlg_CCEAT00300)
		// NOTE: the ClassWizard will add member initialization here
	//}}AFX_DATA_INIT
}


void CDlg_CCEAT00300::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlg_CCEAT00300)
...
BEGIN_MESSAGE_MAP(CDlg_CCEAT00300, CDialog)
	//{{AFX_MSG_MAP(CDlg_CCEAT00300)
...
/////////////////////////////////////////////////////////////////////////////
// CDlg_CCEAT00300 message handlers

BOOL CDlg_CCEAT00300::OnInitDialog() 
{
...
void CDlg_CCEAT00300::OnButtonRequest() 
{
	RequestData();
}
...
// 컨트롤 초기화
//--------------------------------------------------------------------------------------
void CDlg_CCEAT00300::InitCtrls()
{
	int nCol;
	...
	InsertColumn4List( this, IDC_OUTBLOCK1, nCol++, "취소수량            ", FALSE,   16 );    // [long  ,   16] 취소수량            
	...
	InsertColumn4List( this, IDC_OUTBLOCK1, nCol++, "아이템번호          ", FALSE,   10 );    // [long  ,   10] 아이템번호          
...
// 데이터 조회
//--------------------------------------------------------------------------------------
void CDlg_CCEAT00300::RequestData( BOOL bNext )
{
	//-----------------------------------------------------------
// 현물정상주문(CCEAT00300) ( base21=SONAT000,headtype=B )
	CCEAT00300InBlock1	pckInBlock;

	TCHAR			szTrNo[]		= "CCEAT00300";
	char			szNextKey[]		= "";
...
// 데이터를 받음
//--------------------------------------------------------------------------------------
LRESULT CDlg_CCEAT00300::OnXMReceiveData( WPARAM wParam, LPARAM lParam )
{
	//-------------------------------------------------------------------------------------
	// Data를 받음
	if( wParam == REQUEST_DATA )
	{
		...
		} CCEAT00300AllOutBlock, *LPCCEAT00300AllOutBlock;
		
		LPRECV_PACKET			pRpData		 = (LPRECV_PACKET)lParam;
		LPCCEAT00300AllOutBlock pAllOutBlock = (LPCCEAT00300AllOutBlock)pRpData->lpData;
		int						nDataLength  = pRpData->nDataLength;
		int						nCol;
		
		//------------------------------------------------
		// OutBlock1
		nDataLength -= sizeof( CCEAT00300OutBlock1 );
		if( nDataLength < 0 )
		{
			return 0L;
		}
		...
		m_ctrlOutBlock1.SetItemText(  0, nCol++, GetDispData( pAllOutBlock->outBlock1.CancQty          , sizeof( pAllOutBlock->outBlock1.CancQty           ), DATA_TYPE_LONG   ) );    // [long  ,   16] 취소수량            
		...
		//------------------------------------------------
		// OutBlock1
		nDataLength -= sizeof( CCEAT00300OutBlock2 );
		if( nDataLength < 0 )
		{
			return 0L;
		}
...
// Timeout 발생
//--------------------------------------------------------------------------------------
LRESULT CDlg_CCEAT00300::OnXMTimeoutData( WPARAM wParam, LPARAM lParam )
{
	g_iXingAPI.ReleaseRequestData( (int)lParam );
