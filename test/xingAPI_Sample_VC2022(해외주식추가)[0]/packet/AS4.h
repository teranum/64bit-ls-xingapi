...
///////////////////////////////////////////////////////////////////////////////////////////////////
// 해외주식주문거부(미국) ( key=8,group=1 )
#pragma pack( push, 1 )

#define NAME_AS4     "AS4"

// 입력                           
typedef struct _AS4_InBlock
{
} AS4_InBlock, *LPAS4_InBlock;
#define NAME_AS4_InBlock     "InBlock"

// 출력                           
typedef struct _AS4_OutBlock
{
...
} AS4_OutBlock, *LPAS4_OutBlock;
#define NAME_AS4_OutBlock     "OutBlock"
