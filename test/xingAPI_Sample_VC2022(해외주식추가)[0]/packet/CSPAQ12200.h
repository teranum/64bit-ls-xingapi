#ifndef _CSPAQ12200_H_
#define _CSPAQ12200_H_

///////////////////////////////////////////////////////////////////////////////////////////////////
// 현물계좌예수금 주문가능금액 총평가 조회 ( SERVICE=CSPAQ12200,headtype=B,CREATOR=이상은,CREDATE=2015/04/13 08 )
#pragma pack( push, 1 )

#define NAME_CSPAQ12200     "CSPAQ12200"

// In(*EMPTY*)                    
typedef struct _CSPAQ12200InBlock1
{
...
} CSPAQ12200InBlock1, *LPCSPAQ12200InBlock1;
#define NAME_CSPAQ12200InBlock1     "CSPAQ12200InBlock1"

// In(*EMPTY*)                    
typedef struct _CSPAQ12200OutBlock1
{
    char    RecCnt              [   5];    // [long  ,    5] 레코드갯수                      StartPos 0, Length 5
    char    MgmtBrnNo           [   3];    // [string,    3] 관리지점번호                    StartPos 5, Length 3
    char    AcntNo              [  20];    // [string,   20] 계좌번호                        StartPos 8, Length 20
    char    Pwd                 [   8];    // [string,    8] 비밀번호                        StartPos 28, Length 8
    char    BalCreTp            [   1];    // [string,    1] 잔고생성구분                    StartPos 36, Length 1
} CSPAQ12200OutBlock1, *LPCSPAQ12200OutBlock1;
#define NAME_CSPAQ12200OutBlock1     "CSPAQ12200OutBlock1"

// Out(*EMPTY*)                   
typedef struct _CSPAQ12200OutBlock2
{
    char    RecCnt              [   5];    // [long  ,    5] 레코드갯수                      StartPos 0, Length 5
...
} CSPAQ12200OutBlock2, *LPCSPAQ12200OutBlock2;
#define NAME_CSPAQ12200OutBlock2     "CSPAQ12200OutBlock2"

#pragma pack( pop )
///////////////////////////////////////////////////////////////////////////////////////////////////

#endif // _CSPAQ12200_H_
