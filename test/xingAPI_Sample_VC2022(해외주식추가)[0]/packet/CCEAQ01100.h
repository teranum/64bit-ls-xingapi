...
typedef struct _CCEAQ01100InBlock1
{
    ...
    char    PrdgrpClssCode      [   2];    // [string,    2] 상품군코드                      StartPos 49, Length 2
    char    StnlnSeqTp          [   1];    // [string,    1] 정렬순서구분                    StartPos 51, Length 1
...
typedef struct _CCEAQ01100OutBlock3
{
    ...
    char    BnsplAmt            [  16];    // [long  ,   16] 매매손익금액                    StartPos 175, Length 16
