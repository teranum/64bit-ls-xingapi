#ifndef _CSPAQ12300_H_
#define _CSPAQ12300_H_

///////////////////////////////////////////////////////////////////////////////////////////////////
// BEP단가조회 ( SERVICE=CSPAQ12300,headtype=B,CREATOR=이상은,CREDATE=2015/04/13 08 )
#pragma pack( push, 1 )

#define NAME_CSPAQ12300     "CSPAQ12300"

// In(*EMPTY*)                    
typedef struct _CSPAQ12300InBlock1
{
...
} CSPAQ12300InBlock1, *LPCSPAQ12300InBlock1;
#define NAME_CSPAQ12300InBlock1     "CSPAQ12300InBlock1"

// In(*EMPTY*)                    
typedef struct _CSPAQ12300OutBlock1
{
    char    RecCnt              [   5];    // [long  ,    5] 레코드갯수                      StartPos 0, Length 5
    char    AcntNo              [  20];    // [string,   20] 계좌번호                        StartPos 5, Length 20
    char    Pwd                 [   8];    // [string,    8] 비밀번호                        StartPos 25, Length 8
    ...
    char    D2balBaseQryTp      [   1];    // [string,    1] D2잔고기준조회구분              StartPos 35, Length 1
    char    UprcTpCode          [   1];    // [string,    1] 단가구분                        StartPos 36, Length 1
} CSPAQ12300OutBlock1, *LPCSPAQ12300OutBlock1;
#define NAME_CSPAQ12300OutBlock1     "CSPAQ12300OutBlock1"

// Out(*EMPTY*)                   
typedef struct _CSPAQ12300OutBlock2
{
    char    RecCnt              [   5];    // [long  ,    5] 레코드갯수                      StartPos 0, Length 5
...
} CSPAQ12300OutBlock2, *LPCSPAQ12300OutBlock2;
#define NAME_CSPAQ12300OutBlock2     "CSPAQ12300OutBlock2"

// ST_OUT(*EMPTY*)                , occurs
typedef struct _CSPAQ12300OutBlock3
{
...
} CSPAQ12300OutBlock3, *LPCSPAQ12300OutBlock3;
#define NAME_CSPAQ12300OutBlock3     "CSPAQ12300OutBlock3"

#pragma pack( pop )
///////////////////////////////////////////////////////////////////////////////////////////////////

#endif // _CSPAQ12300_H_
