...
typedef struct _t1427InBlock
{
    ...
    char    jshex               [   1];    char    _jshex               ;    // [string,    1] 전일상하한제외                 StartPos 59, Length 1
...
typedef struct _t1427OutBlock1
{
    ...
    char    value               [  12];    char    _value               ;    // [long  ,   12] 거래대금                       StartPos 150, Length 12
    char    total               [  12];    char    _total               ;    // [long  ,   12] 시가총액                       StartPos 163, Length 12
