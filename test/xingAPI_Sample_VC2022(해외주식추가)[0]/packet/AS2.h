...
///////////////////////////////////////////////////////////////////////////////////////////////////
// 해외주식주문정정(미국) ( key=8,group=1 )
#pragma pack( push, 1 )

#define NAME_AS2     "AS2"

// 입력                           
typedef struct _AS2_InBlock
{
} AS2_InBlock, *LPAS2_InBlock;
#define NAME_AS2_InBlock     "InBlock"

// 출력                           
typedef struct _AS2_OutBlock
{
...
} AS2_OutBlock, *LPAS2_OutBlock;
#define NAME_AS2_OutBlock     "OutBlock"
