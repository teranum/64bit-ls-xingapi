...
///////////////////////////////////////////////////////////////////////////////////////////////////
// 해외주식주문취소(미국) ( key=8,group=1 )
#pragma pack( push, 1 )

#define NAME_AS3     "AS3"

// 입력                           
typedef struct _AS3_InBlock
{
} AS3_InBlock, *LPAS3_InBlock;
#define NAME_AS3_InBlock     "InBlock"

// 출력                           
typedef struct _AS3_OutBlock
{
...
} AS3_OutBlock, *LPAS3_OutBlock;
#define NAME_AS3_OutBlock     "OutBlock"
