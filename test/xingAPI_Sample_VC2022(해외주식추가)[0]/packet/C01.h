...
typedef struct _C01_OutBlock
{
    ...
    char    sihogagb            [   1];    // [string,    1] 시장조성호가구분                StartPos 183, Length 1
    char    jakino              [   5];    // [string,    5] 위탁사번호                      StartPos 184, Length 5
    char    daeyong             [  12];    // [string,   12] 대용주권계좌번호                StartPos 189, Length 12
    char    mem_filler          [   7];    // [string,    7] mem_filler                      StartPos 201, Length 7
    char    mem_accno           [  11];    // [string,   11] mem_accno                       StartPos 208, Length 11
    char    mem_filler1         [  42];    // [string,   42] mem_filler1                     StartPos 219, Length 42
