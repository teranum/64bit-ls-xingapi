#ifndef _CSPAQ13700_H_
#define _CSPAQ13700_H_

///////////////////////////////////////////////////////////////////////////////////////////////////
// 현물계좌주문체결내역조회 ( SERVICE=CSPAQ13700,headtype=B,CREATOR=이상은,CREDATE=2015/04/13 08 )
#pragma pack( push, 1 )

#define NAME_CSPAQ13700     "CSPAQ13700"

// In(*EMPTY*)                    
typedef struct _CSPAQ13700InBlock1
{
...
} CSPAQ13700InBlock1, *LPCSPAQ13700InBlock1;
#define NAME_CSPAQ13700InBlock1     "CSPAQ13700InBlock1"

// In(*EMPTY*)                    
typedef struct _CSPAQ13700OutBlock1
{
    char    RecCnt              [   5];    // [long  ,    5] 레코드갯수                      StartPos 0, Length 5
    char    AcntNo              [  20];    // [string,   20] 계좌번호                        StartPos 5, Length 20
    char    InptPwd             [   8];    // [string,    8] 입력비밀번호                    StartPos 25, Length 8
    ...
    char    BkseqTpCode         [   1];    // [string,    1] 역순구분                        StartPos 67, Length 1
    char    OrdPtnCode          [   2];    // [string,    2] 주문유형코드                    StartPos 68, Length 2
} CSPAQ13700OutBlock1, *LPCSPAQ13700OutBlock1;
#define NAME_CSPAQ13700OutBlock1     "CSPAQ13700OutBlock1"

// OUT1(*EMPTY*)                  
typedef struct _CSPAQ13700OutBlock2
{
    char    RecCnt              [   5];    // [long  ,    5] 레코드갯수                      StartPos 0, Length 5
...
} CSPAQ13700OutBlock2, *LPCSPAQ13700OutBlock2;
#define NAME_CSPAQ13700OutBlock2     "CSPAQ13700OutBlock2"

// OUT(*EMPTY*)                   , occurs
typedef struct _CSPAQ13700OutBlock3
{
...
} CSPAQ13700OutBlock3, *LPCSPAQ13700OutBlock3;
#define NAME_CSPAQ13700OutBlock3     "CSPAQ13700OutBlock3"

#pragma pack( pop )
///////////////////////////////////////////////////////////////////////////////////////////////////

#endif // _CSPAQ13700_H_
