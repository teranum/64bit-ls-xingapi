// Dlg_AS1.cpp : implementation file
//
...
IMPLEMENT_DYNCREATE(CDlg_AS1, CDialog)

CDlg_AS1::CDlg_AS1(CWnd* pParent /*=NULL*/)
	: CDialog(CDlg_AS1::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDlg_AS1)
		// NOTE: the ClassWizard will add member initialization here
	//}}AFX_DATA_INIT
}


void CDlg_AS1::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlg_AS1)
	DDX_Control(pDX, IDC_OUTBLOCK, m_ctrlOutBlock);
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CDlg_AS1, CDialog)
	//{{AFX_MSG_MAP(CDlg_AS1)
...
/////////////////////////////////////////////////////////////////////////////
// CDlg_AS1 message handlers

BOOL CDlg_AS1::OnInitDialog() 
{
...
// 데이터를 받음
//--------------------------------------------------------------------------------------
LRESULT CDlg_AS1::OnXMReceiveRealData( WPARAM wParam, LPARAM lParam )
{
	LPRECV_REAL_PACKET pRealPacket = (LPRECV_REAL_PACKET)lParam;

	if( strcmp( pRealPacket->szTrCode, "AS1" ) == 0 )
	{
		LPAS1_OutBlock pOutBlock = (LPAS1_OutBlock)pRealPacket->pszData;
		int nRow = 0;
