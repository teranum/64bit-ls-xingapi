...
void CDlg_t1301::RequestData( BOOL bNext )
{
	...
	CString str_cvolume  ;		GetDlgItemText( IDC_INBLOCK_CVOLUME  , str_cvolume   );		// 특이거래량 
	CString str_starttime;		GetDlgItemText( IDC_INBLOCK_STARTTIME, str_starttime );		// 시작시간   
	CString str_endtime  ;		GetDlgItemText( IDC_INBLOCK_ENDTIME  , str_endtime   );		// 종료시간   
	CString str_cts_time ;		GetDlgItemText( IDC_INBLOCK_CTS_TIME , str_cts_time  );		// 시간CTS    
