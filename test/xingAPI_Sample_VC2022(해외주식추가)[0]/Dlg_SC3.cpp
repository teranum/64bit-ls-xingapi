// Dlg_SC3.cpp : implementation file
//
...
IMPLEMENT_DYNCREATE(CDlg_SC3, CDialog)

CDlg_SC3::CDlg_SC3(CWnd* pParent /*=NULL*/)
	: CDialog(CDlg_SC3::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDlg_SC3)
		// NOTE: the ClassWizard will add member initialization here
	//}}AFX_DATA_INIT
}


void CDlg_SC3::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlg_SC3)
	DDX_Control(pDX, IDC_OUTBLOCK, m_ctrlOutBlock);
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CDlg_SC3, CDialog)
	//{{AFX_MSG_MAP(CDlg_SC3)
...
/////////////////////////////////////////////////////////////////////////////
// CDlg_SC3 message handlers

BOOL CDlg_SC3::OnInitDialog() 
{
...
// 데이터를 받음
//--------------------------------------------------------------------------------------
LRESULT CDlg_SC3::OnXMReceiveRealData( WPARAM wParam, LPARAM lParam )
{
	LPRECV_REAL_PACKET pRealPacket = (LPRECV_REAL_PACKET)lParam;

	if( strcmp( pRealPacket->szTrCode, "SC3" ) == 0 )
	{
		LPSC3_OutBlock pOutBlock = (LPSC3_OutBlock)pRealPacket->pszData;
		int nRow = 0;
