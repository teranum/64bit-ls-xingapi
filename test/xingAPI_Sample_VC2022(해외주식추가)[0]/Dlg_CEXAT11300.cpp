// Dlg_CEXAT11300.cpp : implementation file
//

#include "stdafx.h"
#include "xingapi_sample.h"
#include "Dlg_CEXAT11300.h"
...
IMPLEMENT_DYNCREATE(CDlg_CEXAT11300, CDialog)

CDlg_CEXAT11300::CDlg_CEXAT11300(CWnd* pParent /*=NULL*/)
	: CDialog(CDlg_CEXAT11300::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDlg_CEXAT11300)
		// NOTE: the ClassWizard will add member initialization here
	//}}AFX_DATA_INIT
}


void CDlg_CEXAT11300::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlg_CEXAT11300)
...
BEGIN_MESSAGE_MAP(CDlg_CEXAT11300, CDialog)
	//{{AFX_MSG_MAP(CDlg_CEXAT11300)
...
/////////////////////////////////////////////////////////////////////////////
// CDlg_CEXAT11300 message handlers

BOOL CDlg_CEXAT11300::OnInitDialog() 
{
...
void CDlg_CEXAT11300::OnButtonRequest() 
{
	RequestData();
}
...
// 컨트롤 초기화
//--------------------------------------------------------------------------------------
void CDlg_CEXAT11300::InitCtrls()
{
	int nCol;
...
// 데이터 조회
//--------------------------------------------------------------------------------------
void CDlg_CEXAT11300::RequestData( BOOL bNext )
{
...
// 데이터를 받음
//--------------------------------------------------------------------------------------
LRESULT CDlg_CEXAT11300::OnXMReceiveData( WPARAM wParam, LPARAM lParam )
{
	//-------------------------------------------------------------------------------------
	// Data를 받음
	if( wParam == REQUEST_DATA )
	{
		typedef struct
		{
			CEXAT11300OutBlock1	outBlock1;
			CEXAT11300OutBlock2	outBlock2;
		} CEXAT11300AllOutBlock, *LPCEXAT11300AllOutBlock;

		LPRECV_PACKET			pRpData		 = (LPRECV_PACKET)lParam;
		LPCEXAT11300AllOutBlock pAllOutBlock = (LPCEXAT11300AllOutBlock)pRpData->lpData;
		int						nDataLength  = pRpData->nDataLength;
		int						nCol;
		
		//------------------------------------------------
		// OutBlock1
		nDataLength -= sizeof( CEXAT11300OutBlock1 );
		if( nDataLength < 0 )
		{
			return 0L;
		}
		...
		//------------------------------------------------
		// OutBlock1
		nDataLength -= sizeof( CEXAT11300OutBlock2 );
		if( nDataLength < 0 )
		{
			return 0L;
		}
...
// Timeout 발생
//--------------------------------------------------------------------------------------
LRESULT CDlg_CEXAT11300::OnXMTimeoutData( WPARAM wParam, LPARAM lParam )
{
	g_iXingAPI.ReleaseRequestData( (int)lParam );
